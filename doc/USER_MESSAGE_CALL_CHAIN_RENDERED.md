...
![diagram](./call_chain_mermaid\USER_MESSAGE_CALL_CHAIN_RENDERED-1.png)

## 0.1 Agent 工具决策流程图

![diagram](./call_chain_mermaid\USER_MESSAGE_CALL_CHAIN_RENDERED-2.png)

## 0.2 recipe_query_tool 内部流程图

![diagram](./call_chain_mermaid\USER_MESSAGE_CALL_CHAIN_RENDERED-3.png)

## 0.3 向量召回层流程图

![diagram](./call_chain_mermaid\USER_MESSAGE_CALL_CHAIN_RENDERED-4.png)

## 0.4 SSE 回传与前端渲染流程图

![diagram](./call_chain_mermaid\USER_MESSAGE_CALL_CHAIN_RENDERED-5.png)
